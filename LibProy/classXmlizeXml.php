...

{
	...
	function xmlize_xml($data, $WHITE=1) {
	   ...
	   {
			if (!$desarrollo){
	   			//print '<pre>'; print_r("XML error: ".xml_error_string(xml_get_error_code($parser))." at line ".xml_get_current_line_number($parser)); print '</pre>';
			}

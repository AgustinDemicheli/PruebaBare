		...
		<div class="nav-wrapper">
			<div class="main-box clearfix">
				...
				<div class="social clearfix">
					<a class="fb" href="javascript:facebookDialog('http://<?=$_SERVER["HTTP_HOST"]?>','Gu�a Poder Judicial de la Ciudad Aut�noma de Buenos Aires');">Facebook</a>
					<a class="tw" href="javascript:twitterDialog('Gu�a Poder Judicial de la Ciudad Aut�noma de Buenos Aires ','http://<?=$_SERVER["HTTP_HOST"]?>');">Twitter</a>

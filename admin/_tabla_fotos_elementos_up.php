...
<table  id="tabla_upload" width="100%" cellspacing="0" cellpadding="3">
	 <!-- Titulos -->	 
		 <tr class="tablaOscuro"> 
            ...
            <td class="titulooferta" align="center">Fot&oacute;grafo</td>
	...
	<!-- /Titulos -->
		...
		<tr id="tr_clone" style="display:none;"> 
		   ...
		   <td class="titulooferta" style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">
		   		<input type="file" name="file_foto[]" value=""/>
		   </td>
		   <td class="titulooferta" style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">
		   		<input type="text" name="titulo_foto[]" class="comun_libre" />
		   </td>
            <td class="titulooferta" style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">
		   	<select class="comun" name="id_fotografo[]"><?php GetFotografos()?></select>
		   </td>
		   <td class="titulooferta" style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;"> 
		   	<select class="comun" name="id_categoria_foto[]"><?php  GetCategoriasMultimedia(0, $cat_id, false)?></select>
		   </td>

...
$extended_version = intval($_REQUEST["extended_version"]);
//mensajes de error
if ($tipo == "F") {
...
if ($tipo == "V") {
    ...
    $ext_permitidas = array('flv', 'mpg', 'avi', 'wmv', 'f4v','webm','mp4');
...
if ($tipo == "D") {
    ...
    $ext_permitidas = array('xls', 'pdf', 'ppt', 'pps', 'doc', 'zip', 'rar', 'odt', 'txt', 'rtf', 'swf');
        ...
        <DIV class="why" id="outerDiv">
            ...
            <form id="frmUpload" name="frmFile" action="<?php echo $_SERVER["PHP_SELF"] ?>?tipo=<?php echo $tipo ?>" enctype="multipart/form-data" method="POST">
                <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" style="background-image:url(images/separador_h8.gif); background-repeat:repeat-x; background-position:bottom;">
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#ffffff" colspan="3">
                            ...
                            if ($tipo == "V") {
                                require_once '_tabla_videos_elementos_up.php';
                            }
                            if ($tipo == "D") {
                    ...
                    <tr>
                        <td align="center" valign="bottom" colspan="20" bgcolor="#e5e5e5" class="titulooferta" >
                            ...
                            <br />Tamaño máximo: <?php echo $tam_max; ?>
                        </td>
                ...
                <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" style="background-image:url(images/separador_h8.gif); background-repeat:repeat-x; background-position:bottom;">
                    ...
                    <td align="center" bgcolor="#e5e5e5">&nbsp;</td>
                    <td align="center" bgcolor="#e5e5e5" colspan="3"><img onclick='document.location="index.php?=menu=<?= $usr->_menu; ?>";' src="images/btn_volver.gif" border="0" style="cursor:pointer;">&nbsp;&nbsp;&nbsp;

<? 
			...
			{ 
				if(isset($_POST["id"])&&is_numeric($_POST["id"])) 
				{
					...
					$sql = "update imagenes_responsivas set nombre = '".$_POST['nombre']."',id_imagen = '".$_POST['id_imagen']."',id_imagen_responsive = '".$_POST['id_imagen_responsive']."',activo = '".$_POST['activo']."' where id = ".$_POST["id"];
					$conn->execute($sql); 
					$id = $_POST["id"];
				...
				{ 
					$sql = "insert into imagenes_responsivas (nombre,id_imagen,id_imagen_responsive,activo) values ('".$_POST['nombre']."','".$_POST['id_imagen']."','".$_POST['id_imagen_responsive']."','".$_POST['activo']."')"; 
					$conn->execute($sql); 
				...
				{
					header("Location: imagenes.php?p=".$_REQUEST['p']."&orden=".$_REQUEST['orden']."&filtros=".$_REQUEST['filtros']."&filtros_p=".$_REQUEST['filtros_p']);
					die();
				}
				else
				{
			...
			if(isset($_GET["id"])) 
			{ 
				$sql = "select * from imagenes_responsivas where id = ".$_GET["id"]; 
				$rs = $conn->execute($sql); 
			...
			?><html>
    <head>
        <title><?=$TITULO_SITE?> - Imagenes alternativas</title>
    ...
    <body class="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" scroll='no'>
        ...
        <div class="why" id="outerDiv">  <br>
            <table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" class="Title" style="padding-bottom:10px;"><?=$TITULO_SITE?> - Imagenes alternativas</td>
                </tr>
            </table>
            <table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
                <!--
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#e5e5e5"><table width='50%' border="0" cellpadding="0" cellspacing="5">
                                <tr>
                                    ...
                                    <td align='center' style="padding-right:15px;"><img onclick='document.location = "imagenes.php?=menu=<?=$usr->_menu;?>";' src="images/btn_volver.gif" border="0" style="cursor:pointer;">
                                    </td>
                ...
                <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" style="background-image:url(images/separador_h8.gif); background-repeat:repeat-x; background-position:bottom;">
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="3" style="border-collapse: collapse;">
                                ...
                                <tr <?=(false == true && $bilingual == false)? "style=\"display: none;\"":"";?>>
                                    <td width='40%' align="right" valign="top" class='arial12' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">Imagen original&nbsp;<img src="images/arrow_derecha.gif"></td>
								...
								<?
									...
									if($id_imagen>0)
									{
										...
										$sql = "select advID,advLink,advTitulo from advf where advID = ".$id_imagen;
										$rs = $conn->execute($sql);

										$image_name = $rs->field("advTitulo");
									}
								?>
									<input type='text' class='comun' name='id_imagen_image' readonly value='<?=$image_name;?>'>					
									<input type='hidden' name='id_imagen' value='<?=(isset($_GET["id"])?$id_imagen:"")?>'>
									<a href="javascript: openMedia('<?=(isset($_GET["id"]))? $id_imagen:"";?>','F','id_imagen','0');"><img border="0" src="images/examinar.gif"></a>
									<a href="javascript: clearMedia('F','id_imagen');"><img border="0" src="images/eliminar.gif"></a>
									<?
									if($id_imagen>0)
									{
									?>
										<div id='preview_image_id_imagen' name='preview_image_id_imagen' style='padding:3px;'>
                                ...
                                <tr <?=(false == true && $bilingual == false)? "style=\"display: none;\"":"";?>>
                                    <td width='40%' align="right" valign="top" class='arial12' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">Imagen vertical&nbsp;<img src="images/arrow_derecha.gif"></td>
                                    <td width="60%" class='arial11' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">
								<?
									$image_name ="";
									if($id_imagen_responsive>0)
									{
										// Quiere decir que hay algun numero, asi que lo mostramos
										$sql = "select advID,advLink,advTitulo from advf where advID = ".$id_imagen_responsive;
										$rs = $conn->execute($sql);

										$image_name = $rs->field("advTitulo");
									}
								?>
									<input type='text' class='comun' name='id_imagen_responsive_image' readonly value='<?=$image_name;?>'>					
									<input type='hidden' name='id_imagen_responsive' value='<?=(isset($_GET["id"])?$id_imagen_responsive:"")?>'>
									<a href="javascript: openMedia('<?=(isset($_GET["id"]))? $id_imagen_responsive:"";?>','F','id_imagen_responsive','0');"><img border="0" src="images/examinar.gif"></a>
									<a href="javascript: clearMedia('F','id_imagen_responsive');"><img border="0" src="images/eliminar.gif"></a>
									<?
									if($id_imagen_responsive>0)
									{
									?>
										<div id='preview_image_id_imagen_responsive' name='preview_image_id_imagen_responsive' style='padding:3px;'>
										<a href='../<?=$rs->field("advLink")?>' target='_blank'><img src='thumbs.php?w=50&h=50&id=<?=$rs->field("advID")?>' width='50' height='50' style='border:1px solid #AEAEAE'></a>
										</div>
									<?
									}
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#e5e5e5"><table width='50%' border="0" cellpadding="0" cellspacing="5">
                                <tr>
                                    ...
                                    <td align='center' style="padding-right:15px;"><img border="0" onclick='document.location = "imagenes.php?=menu=<?=$usr->_menu;?>";' src="images/btn_volver.gif" style="cursor:pointer;">
                                    </td>
                                    <td align='center' style="background-image:url(images/separador_v.gif); background-repeat:repeat-y; background-position:left; padding-left:15px;"><? if(($usr->checkUserRights(4, $id) != 'disabled') || (!$id)) print('<input name="imageField2" type="image" id="imageField2" onclick="javascript:set_type(0);" src="images/btn_guardar.gif">'); ?></td>
                                    <td align='center'><? if(($usr->checkUserRights(4, $id) != 'disabled') || (!$id)) print('<input name="imageField2" type="image" id="imageField2" src="images/btn_guardaryvolver.gif" onclick="javascript:set_type(1);" value=\'Guardar y volver al listado\'>'); ?></td>
                                </tr>

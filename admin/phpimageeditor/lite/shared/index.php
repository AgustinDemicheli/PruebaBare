...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    ...
	    <script type="text/javascript" src="lite/shared/javascript/jquery-1.3.2.min.js"></script>
	    ...
	    <script type="text/javascript" src="lite/shared/javascript/jquery-ui-1.7.3.custom.min.js"></script>
				...
				<?php if (!$objPHPImageEditor->ErrorHasOccurred()) { ?>
					...
					<div class="tabs">
						...
						<div id="actionContainer">
							...
							<div id="panel_<?php PIE_Echo(MENU_CROP); ?>" class="panel">
								...
								<div class="field crop-settings">
									...
									<select name="coord" onchange='javascript: resizePreseleccionado(this.value);'>
										<option value="">Preseelccionados</option>
										<option value="1">600x400</option>
										<option value="2">980x650</option>
										<option value="3">636x424</option>
										<option value="4">320x213</option>
									</select>
								</div>
							</div>
							<div id="panel_<?php PIE_Echo(MENU_EFFECTS); ?>" class="panel">
								<div class="field">
						...
						<div class="main-actions">
							...
							Nueva Descripcion
							<input class="input-number" type="text" name="newTitle" id="newTitle" value="<?="Editada - ".$descFoto?>" style="width:250px;"/>

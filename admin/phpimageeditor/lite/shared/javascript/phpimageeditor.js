...
function resizePreseleccionado(t)
{
	switch(t)
	{
		case "1":
			objCrop.setSelect([0,0,600,400]);
			break;
		case "2":
			objCrop.setSelect([0,0,980,650]);
			break;
		case "3":
			objCrop.setSelect([0,0,636,424]);
			break;
		case "4":
			objCrop.setSelect([0,0,320,213]);
			break;
		default:
			break;
	}

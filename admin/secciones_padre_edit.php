...
$sql = "update secciones_padre set titulo = '".$_POST['titulo']."',titulo_menu = '".$_POST['titulo_menu']."',menu_orden = '".$_POST['menu_orden']."',activo = '".$_POST['activo']."',link_menu = '".$_POST['link_menu']."' where id = ".$_POST["id"];
...
$sql = "insert into secciones_padre (titulo,titulo_menu,menu_orden,activo,link_menu) values ('".$_POST['titulo']."','".$_POST['titulo_menu']."','".$_POST['menu_orden']."','".$_POST['activo']."','".$_POST['link_menu']."')"; 
...
header("Location: secciones_padre.php?p=".$_REQUEST['p']."&orden=".$_REQUEST['orden']."&filtros=".$_REQUEST['filtros']."&filtros_p=".$_REQUEST['filtros_p']);
...
{ 
	...
	$sql = "select * from secciones_padre where id = ".$_GET["id"]; 
...
?><html>
    <head>
        <title><?=$TITULO_SITE?> - Secciones Principales</title>
    ...
    <body class="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" scroll='no'>
        ...
        <div class="why" id="outerDiv">  <br>
            <table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" class="Title" style="padding-bottom:10px;"><?=$TITULO_SITE?> - Secciones Principales</td>
                </tr>
            </table>
            <table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
                <!--
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#e5e5e5"><table width='50%' border="0" cellpadding="0" cellspacing="5">
                                <tr>
                                    ...
                                    <td align='center' style="padding-right:15px;"><img onclick='document.location = "secciones_padre.php?=menu=<?=$usr->_menu;?>";' src="images/btn_volver.gif" border="0" style="cursor:pointer;">
                                    </td>
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="3" style="border-collapse: collapse;">
                                ...
                                <tr <?=(false == true && $bilingual == false)? "style=\"display: none;\"":"";?>>
                                    <td width='40%' align="right" valign="top" class='arial12' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">Titulo&nbsp;<img src="images/arrow_derecha.gif"></td>
                                    <td width="60%" class='arial11' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;"><input id='titulo'  name='titulo' type='textbox' class='comun' value='<?=(isset($id)?htmlentities($titulo,ENT_QUOTES):"")?>'>
                                ...
                                <tr <?=(false == true && $bilingual == false)? "style=\"display: none;\"":"";?>>
                                    <td width='40%' align="right" valign="top" class='arial12' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;">Titulo en el menu&nbsp;<img src="images/arrow_derecha.gif"></td>
                                    <td width="60%" class='arial11' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;"><input id='titulo_menu'  name='titulo_menu' type='textbox' class='comun' value='<?=(isset($id)?htmlentities($titulo_menu,ENT_QUOTES):"")?>'>
                                ...
                                <tr <?=(false == true && $bilingual == false)? "style=\"display: none;\"":"";?>>
                                    ...
                                    <td width="60%" class='arial11' style="background-image:url(images/separador_h1.gif); background-repeat:repeat-x; background-position:bottom; padding:7px;"><input id='menu_orden'  name='menu_orden' type='textbox' class='comun' value='<?=(isset($id)?htmlentities($menu_orden,ENT_QUOTES):"")?>'>
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#e5e5e5"><table width='50%' border="0" cellpadding="0" cellspacing="5">
                                <tr>
                                    ...
                                    <td align='center' style="padding-right:15px;"><img border="0" onclick='document.location = "secciones_padre.php?=menu=<?=$usr->_menu;?>";' src="images/btn_volver.gif" style="cursor:pointer;">
                                    </td>
                                    <td align='center' style="background-image:url(images/separador_v.gif); background-repeat:repeat-y; background-position:left; padding-left:15px;"><? if(($usr->checkUserRights(4, $id) != 'disabled') || (!$id)) print('<input name="imageField2" type="image" id="imageField2" onclick="javascript:set_type(0);" src="images/btn_guardar.gif">'); ?></td>
                                    <td align='center'><? if(($usr->checkUserRights(4, $id) != 'disabled') || (!$id)) print('<input name="imageField2" type="image" id="imageField2" src="images/btn_guardaryvolver.gif" onclick="javascript:set_type(1);" value=\'Guardar y volver al listado\'>'); ?></td>
                                </tr>

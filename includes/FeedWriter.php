 ...
 */
 class FeedWriter
 {
	...
	* @return   void
	*/ 
	public function generateFeed($toScreen = false)
	{       
                $output = '';
		$output .= $this->printHead();
		$output .= $this->printChannels();
		$output .= $this->printItems();
		$output .= $this->printTale();
	...
	*/
	...
	{
		$this->setChannelElement('author', $title);
	}
